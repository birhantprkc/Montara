...
| Revideo and Motion Canvas installed-runtime validate proofs | Revideo selection is license-aware now; this turns the remaining runtime-gated adapters into verified native renderers. |
