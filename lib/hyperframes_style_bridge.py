"""Bridge Montara playbooks → HyperFrames-friendly style artifacts.

Montara playbooks are YAML files describing visual_language, typography,
...
def _render_design_md(
    ...
    lines = [
        title,
        "",
        f"> Generated by Montara HyperFrames style bridge (source: {source_note}).",
        "",
        "## Colors",
        "",
