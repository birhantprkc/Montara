# Montara - Shared Project Context
...
Montara is an open-source, AI-orchestrated video production platform.
...
Layer 2: skills/                    → "How Montara uses them" (project conventions)
...
| `skills/core/hyperframes.md` | Layer 2 — when Montara should pick HyperFrames vs Remotion, artifact → workspace mapping |
